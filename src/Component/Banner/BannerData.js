...
import fetchData from "../../ApiHandler/bannerApi";
...
function BannerData({home}) {
  ...
  const TotalPages = Math.ceil(home.length / ITEMS_PER_PAGE);
  ...
  //       setBannerData(data);
  //       dispatch(bannerDataList(data)); // Dispatch the data to the Redux store
  //     } catch (error) {
