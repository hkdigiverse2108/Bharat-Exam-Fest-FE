...
import { fetchKycData, handleUpdateKyc, updateKycStatus } from "../../ApiHandler/useGetKycApi";
                  ...
                  <>
                    <tr key={_id} className="border-y border-slate-200">
                      ...
                      <td className="p-3 whitespace-nowrap">
                        ...
                        >
                          <option value="verified" className="bg-green-100 text-green-600">
                            Verified
                          </option>
                          <option value="pending" className="bg-yellow-100 text-yellow-600">
                            Pending
                          </option>
                          <option value="unverified" className="bg-red-100 text-red-600">
                            Unverified
                          </option>
                        </select>
                      </td>
