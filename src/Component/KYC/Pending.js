          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr className="border-y border-slate-200">
                ...
                <td class="p-3 whitespace-nowrap">
                  <li class="px-2  text-sm leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">
                    Pending
                  </li>
                </td>
                <td class="p-3 whitespace-nowrap">
              ...
              <tr className="border-y border-slate-200">
                ...
                <td class="p-3 whitespace-nowrap">
                  <button class="px-4 py-1 font-medium text-white bg-orange-600 rounded-md hover:bg-orange-500 focus:outline-none focus:shadow-outline-blue Pending:bg-blue-600 transition duration-150 ease-in-out">
                    save
                  </button>
                </td>
              </tr>
